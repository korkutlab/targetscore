...
#' @param matrix_wk_output_file a filename to write matrix inferred network wk (default: NULL)
...
#' @param signed_matrix_wk_output_file a filename to write matrix inferred network wks (default: NULL)
#' @param random_target_score_file a filename to write random target score generated by random network (default: NULL)
#'
#' @details
