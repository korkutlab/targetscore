...
write.table(ts_sd_c1,file=paste0(cellLine1,"_TS_stdev.txt"))
write.table(ts_sd_c2,file=paste0(cellLine2,"_TS_stdev.txt"))
write.table(ts_sd_c3,file=paste0(cellLine3,"_TS_stdev.txt"))
write.table(ts_sd_c4,file=paste0(cellLine4,"_TS_stdev.txt"))
