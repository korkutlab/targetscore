...
### Read Antibody File 
This file represents [FIXME_DESCRIPTION]

#### Columns
* FIXME_target_symbol: Gene symbol of drug target
* FIXME_target_id: Target DrugBank ID (e.g., https://go.drugbank.com/bio_entities/BE0009463)
* FIXME_drug_name: Drug name
