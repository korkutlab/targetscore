...
data1 <- read.table(file="ovcar3_TS_d_p1.txt",header=T)
data0 <- read.table(file="ovcar3_TS_d_p0.txt",header=T) 
err1 <-  read.table(file="ovcar3_TS_stdev_p1.txt",header=T)
err0 <-  read.table(file="ovcar3_TS_stdev_p0.txt",header=T)
