...
for(i in 1:length(cellLines)) {
    ...
    datFile <- paste0(folder, cellLines[i], "_spR_TS.txt")
    ...
    # Label points with the protein expression correlates (Spearman) is greater than 0.7 and the TargetScore is in the top 10%
